...
from mailscan2026.core import audit_report, session_store
...
def install_review_quality_tools(
    ...
    def classify_unclassified_documents(self):
        ...
        for row in range(self.table.rowCount()):
            ...
            if not doc_type or doc_type == "Unknown" or not sender or confidence in ("", "low"):
                rows.append(row)
    ...
    def update_classify_button_state_with_review(self):
        ...
        for name in ["classify_unclassified_button", "classify_flagged_button", "generate_audit_button"]:
